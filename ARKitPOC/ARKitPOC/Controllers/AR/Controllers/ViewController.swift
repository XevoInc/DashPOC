...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var previousArrowView: UIView!
    ...
    override func viewDidLoad() {
        ...
        let width = self.previousArrowView.bounds.size.width
        self.previousArrowView.layer.cornerRadius = width / 2.0
    }
    ...
    @IBAction func previousPageSelected(sender: UIButton) {
        self.pageController?.moveToML()
    }
