...
class AngleGradientBorderLayer: AngleGradientLayer {
  ...
  override func draw(in ctx: CGContext) {
    ...
    let shapePath = UIBezierPath(arcCenter: CGPoint(x: bounds.midX, y: bounds.midY), radius: bounds.width/2 - gradientBorderWidth/2, startAngle: 1.57, endAngle: 3.14, clockwise: true)
